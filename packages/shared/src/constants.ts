...
export const AGENT_ROLES = [
  ...
  "infrastructure_devops_engineer",
...
export const AGENT_ROLE_LABELS: Record<AgentRole, string> = {
  ...
  crdo: "Chief Research and Design Officer",
  security: "Security",
  engineer: "Engineer",
  designer: "Designer",
  pm: "PM",
  ...
  build_queue_manager: "Build Queue Manager",
  ...
  platform_release_manager: "Platform Release Manager",
  ...
  security_compliance_specialist: "Security and Compliance Specialist",
  storage_steward: "Storage Steward",
  maintenance_manager: "Maintenance Manager",
  agent_improver: "Agent Improver",
  skill_improver: "Skill Improver",
  ...
  meeting_follow_through: "Meeting Follow-Through",
  idea_sounding_board: "Idea Sounding Board",
  general: "General",
};

export const AGENT_ROLE_FAMILIES = [
  "executive_leadership",
  "product_program",
  "engineering_architecture",
  "quality_verification",
  "release_delivery_operations",
  "platform_reliability_maintenance",
  "research_design",
  "revenue_growth",
...
export type AgentRoleFamily = (typeof AGENT_ROLE_FAMILIES)[number];

export const AGENT_ROLE_FAMILY_LABELS: Record<AgentRoleFamily, string> = {
  executive_leadership: "Executive Leadership",
  product_program: "Product and Program",
  engineering_architecture: "Engineering and Architecture",
  quality_verification: "Quality and Verification",
  release_delivery_operations: "Release and Delivery Operations",
  platform_reliability_maintenance: "Platform Reliability and Maintenance",
  research_design: "Research and Design",
  revenue_growth: "Revenue and Growth",
  administration_coordination: "Administration and Coordination",
  security: "Security",
  general: "General",
};

export const AGENT_ROLE_FAMILY_BY_ROLE: Record<AgentRole, AgentRoleFamily> = {
  ceo: "executive_leadership",
  cto: "executive_leadership",
  cmo: "executive_leadership",
  cfo: "executive_leadership",
  coo: "executive_leadership",
  cao: "executive_leadership",
  crdo: "executive_leadership",
  security: "security",
  engineer: "engineering_architecture",
  designer: "research_design",
  pm: "product_program",
  qa: "quality_verification",
  devops: "platform_reliability_maintenance",
  researcher: "research_design",
  program_manager: "product_program",
  product_manager: "product_program",
  build_queue_manager: "product_program",
  engagement_manager: "product_program",
  spec_writer: "product_program",
  prd_writer: "product_program",
  tester: "quality_verification",
  builder: "engineering_architecture",
  architect: "engineering_architecture",
  release_manager: "release_delivery_operations",
  platform_release_manager: "release_delivery_operations",
  pod_devops: "release_delivery_operations",
  it_support_specialist: "platform_reliability_maintenance",
  infrastructure_devops_engineer: "platform_reliability_maintenance",
  security_compliance_specialist: "security",
  storage_steward: "platform_reliability_maintenance",
  maintenance_manager: "platform_reliability_maintenance",
  agent_improver: "platform_reliability_maintenance",
  skill_improver: "platform_reliability_maintenance",
  agent_doctor: "platform_reliability_maintenance",
  root_cause_engineer: "platform_reliability_maintenance",
  uptime_services: "platform_reliability_maintenance",
  reviewer: "quality_verification",
  independent_verifier: "quality_verification",
  sales_research: "revenue_growth",
  demand_generation: "revenue_growth",
  organic_growth: "revenue_growth",
  outside_sales: "revenue_growth",
  sales_coach: "revenue_growth",
  sales_manager: "revenue_growth",
  vp_sales: "revenue_growth",
  email_manager: "administration_coordination",
  meeting_prep: "administration_coordination",
  meeting_follow_through: "administration_coordination",
  idea_sounding_board: "administration_coordination",
  general: "general",
};
